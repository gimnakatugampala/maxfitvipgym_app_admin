...
<head>
    ...
    <title>Maxfit VIP Gym | Assign Workout Schedule</title>
                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Assign Workout Schedule</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>Assign workout schedules</h5>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-lg-10"><select class="form-control m-b" name="account">
                                        <option>GIMNA KATUGAMPALA</option>
                                        <option>JOHN DOE</option>
                                        <option>MARY SMITH</option>
                                        <option>GIMNA KAVISHKA</option>
                                    </select></div>
                            </div>
                        </div>
                        <div class="col-md-6">
